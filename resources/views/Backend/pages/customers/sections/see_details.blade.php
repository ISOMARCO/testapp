                ...
                <div class="row">
                    <div class="col-6 col-lg-6">
                        <div class="row g-9 mb-8">
                            <div class="fv-row mb-7 col-12">
                                <label
                                    class="fw-semibold fs-6 mb-2" for="name">Müştəri adı</label>
                                <input type="text" name="name" class="form-control  mb-3 mb-lg-0"
                                       placeholder="Adı" id="name" disabled="disabled"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-lg-6">
                        <div class="row g-9 mb-8">
                            <div class="fv-row mb-7 col-12">
                                <label class="fw-semibold fs-6 mb-2" for="surname">Müştəri soyadı</label>
                    ...
                    <div class="col-6 col-lg-6">
                        <div class="row g-9 mb-8">
                            <div class="fv-row mb-7 col-12">
                                <label
                                    class="fw-semibold fs-6 mb-2" for="country">Ölkə</label>
                                <select name="country" id="country" class="form-control mb-3 mb-lg-0" disabled="disabled">
