                ...
                <div class="mw-lg-600px mx-auto">
                    ...
                    <div class="d-flex">
                        <a href="#" class="btn btn-light w-100">
                            <img alt="Logo"
                                 src="{{ asset('assets/media/svg/social-logos/google.svg') }}"
                                 class="h-15px me-3" />Import Contacts</a>
                        <a href="#" class="btn btn-light w-100 mx-6">
                            <img alt="Logo"
                                 src="{{ asset('assets/media/svg/social-logos/facebook.svg') }}"
                                 class="h-20px me-3" />Facebook</a>
                        <a href="#" class="btn btn-light w-100">
                            <img alt="Logo"
                                 src="{{ asset('assets/media/svg/social-logos/twitter.svg') }}"
                    ...
                    <div class="d-flex align-items-center mt-10">
                        <!--begin::Label-->
                        <div class="flex-grow-1">
                                <span class="fs-6 fw-semibold text-gray-800 d-block">Adding Users by Team
                                    Members</span>
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" class="form-control " placeholder="Enter Deal Title"
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Label-->
                                    <textarea class="form-control " rows="3" placeholder="Enter Deal Description" name="details_description">Experience share market at your fingertips with TICK PRO stock investment mobile trading app</textarea>
                                    <!--end::Label-->
                                </div>
                                <!--end::Input group-->
                                <!--begin::Input group-->
                                <div class="fv-row mb-8">
                                    ...
                                    <div class="position-relative d-flex align-items-center">
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Datepicker-->
                                        <input class="form-control  ps-12" placeholder="Pick date range"
                            ...
                            <div class="w-100">
                                ...
                                <div class="fv-row mb-8">
                                    ...
                                    <div class="position-relative w-lg-250px" id="kt_modal_finance_setup"
                                        ...
                                        <!--begin::Input control-->
                                        <input type="text" class="form-control  border-0 ps-12"
                        ...
                        <div data-kt-stepper-element="content">
                            ...
                            <div class="w-100">
                                ...
                                <div class="text-center px-4">
                                    <img src="{{ asset('assets/media/illustrations/sketchy-1/20.png') }}"
...
<!--end::Modals-->
<!--begin::Toast-->
<div id="kt_docs_toast_stack_container" class="toast-container position-fixed top-0 end-0 p-3 z-index-99">
    <div class="toast" role="alert" aria-live="assertive" aria-atomic="true" data-kt-docs-toast="stack"
        ...
        <div class="toast-header">
            ...
            <strong class="me-auto toast-title">Keenthemes</strong>
            <small class="toast-date">11 mins ago</small>
